...
if __name__ == '__main__':
    try:
        ...
        result = os.popen('ls && rm -f final.output').read()
        log(file, result)
        ...
        result = os.popen('cat predict_result4.txt >> final.output && cat predict_result7.txt >> final.output && echo "start time:" >> final.output && cat test_images/start.time1 >> final.output && ./client final.output 172.18.0.4 12347 ').read()
        log(file, result)
